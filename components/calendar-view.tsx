...
export default function CalendarView() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0b233a] to-yellow-50">
      <div className="container mx-auto px-4 py-8">
        <Card className="w-full max-w-6xl mx-auto border-yellow-200 shadow-lg">
          <CardHeader className="bg-gradient-to-r from-[#071f37] to-yellow-500 text-white p-4 sm:p-6">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              <CardTitle className="text-lg sm:text-xl flex items-center gap-2">
                <Calendar className="w-5 h-5" />
                <span>Calendrier des accès résidentiels</span>
              </CardTitle>
              <Button
                variant="ghost"
            ...
            <p className="text-sm text-yellow-100">
              Visualisez les accès programmés et leurs échéances
            </p>
          </CardHeader>
                ...
                return (
                  <div
                    ...
                    className={`
                      ...
                      ${isToday(day.date) ? "ring-2 ring-yellow-500 bg-yellow-50" : ""}
