...
export default function QRShare({ qrCodeData, formData }: QRShareProps) {
  ...
  // Générer l'URL de partage (vous pouvez l'adapter selon votre domaine)
    ...
    <div className="space-y-4">
      ...
      <Dialog>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4">
            {/* Aperçu du QR Code */}
            <div className="flex justify-center p-4 bg-orange-50 rounded-lg border border-orange-200">
